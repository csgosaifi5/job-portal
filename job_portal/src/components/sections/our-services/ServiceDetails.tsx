...
const ServiceDetails = ({serviceData}:any) => {
  
  return (
    <>
      <div className="page-content bg-white">
        <BannerTitle motherName="Home" activeName={serviceData.title} imageUrl={serviceData.banner_image} />
                  ...
                  <div className="dez-post-meta">
                    <ul className="d-flex align-items-center">
                      <li className="post-date">
                        <i className="fa fa-calendar"></i>{util.formatDate(serviceData.createdAt)}
                      </li>
