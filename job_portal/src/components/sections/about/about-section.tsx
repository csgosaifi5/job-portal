...
const AboutSection = async () => {
  ...
  return (
    <div className="page-content bg-white">
      <BannerTitle activeName="About Us" motherName="Home" imageUrl={aboutUsData.banner_image} />
          ...
          <div className="container">
            <div className="row image-text-grid-outer">
              <div className="image-outer-con image-outer-con02">
                <img src={aboutUsData.image} alt="icon" className="object-fit-cover image-left-con" />
              
              </div>

              <h2 className="m-b5">About Us</h2>
                <h3 className="fw4">{aboutUsData.title}</h3>
             {aboutUsData.description && <div dangerouslySetInnerHTML={{ __html: aboutUsData.description }} />}   
