            ...
            <CContainer className="d-flex flex-column gap-3">
              {formik.values.screen_content.map((el, index) => (
                <CCard key={'item' + index} className={'d-flex flex-column gap-3 p-3'}>
                  ...
                  <CRow>
                    ...
                    <CCol className={window.innerWidth < 576 ? 'col-12' : 'col-6'}>
                      ...
                      <CFormInput
                        ...
                        id="link"
                        placeholder="Link"
                        value={formik.values.screen_content[index]?.link}
                        name={`screen_content[${index}].link`}
                        onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                        className={
                          formik.touched.screen_content &&
                          formik.touched.screen_content[index]?.link &&
                          formik.errors.screen_content &&
                          formik.errors.screen_content[index]?.link
                            ? ' border-danger'
                            : ''
                        }
                      />
                  ...
                  <CRow>
                    <CCol>
                      <CFormLabel htmlFor={`image${index}`}>Image*</CFormLabel>
                      <CFormInput
                        type="file"
                        id={`image${index}`}
                        placeholder="Image"
